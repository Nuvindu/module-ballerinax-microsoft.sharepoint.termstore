...
The `Microsoft SharePoint Termstore` connector provides practical examples illustrating usage in various scenarios. Explore these [examples](https://github.com/module-ballerinax-microsoft.sharepoint.termstore/tree/main/examples/), covering the following use cases:
